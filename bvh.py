...
class Joint:
  ...
  def info(self):
    ...
    print (self.name,' is connected to ')
...
class Skeleton:
    ...
    def __init__(self, filename, scale):
        ...
        self.numJoint = 0
        self.root.myIndex = self.numJoint
        self.numJoint = self.numJoint + 1
        self.jointList = []
        self.jointList.append(self.root)
    ...
    def __readJoint(self, joint, scale=0.25):
        ...
        while 1:
            ...
            if items[0] == 'JOINT':
                ...
                child.myIndex = self.numJoint
                self.numJoint = self.numJoint + 1                
                self.jointList.append(child)
